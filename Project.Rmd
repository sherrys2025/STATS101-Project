...
consider = c(2, 13, 35, 36, 47, 49, 50, 55, 57)
```
...
```{r}
#making sure they have the same amount of predictors, so predict() doesn't give NAs
...
##need to fill in NAs in newTestData with mean thing
