...
```{r}
paste("Pred. int for lm model: ", predInt1[,1], "to", predInt1[,3])
paste("Pred. int for log. lm model: ", predInt2[,1], "to", predInt2[,3])
paste("Pred. int for sqrt. model: ", predInt3[,1], "to", predInt3[,3])
paste("Pred. int for initial tree model: ", predInt4[,1], "to", predInt4[,3])
paste("Pred. int for pruned tree model: ", predInt5[,1], "to", predInt5[,3])
