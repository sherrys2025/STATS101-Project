...
```{r}
paste("Pred. int for lm model: ", mean(predInt1[,1]), "to", mean(predInt1[,3]))
paste("Pred. int for log. lm model: ", mean(predInt2[,1]), "to", mean(predInt2[,3]))
paste("Pred. int for sqrt. model: ", mean(predInt3[,1]), "to", mean(predInt3[,3]))
paste("Pred. int for initial tree model: ", mean(predInt4[,1]), "to", mean(predInt4[,3]))
paste("Pred. int for pruned tree model: ", mean(predInt5[,1]), "to", mean(predInt5[,3]))
