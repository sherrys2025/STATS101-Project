...
#calculating R^2
ss_residual <- sum((actuals - predictions_log)^2, na.rm = TRUE)
rsquared <- 1 - (ss_residual / ss_total)
rsquared
...
#this model leads to test predictions that are (on average) within approximately $64058.58$ of the true median home value for the census tract. Pruning gets rid of noise-y things, so the performence is "worse" but more general.
